...
import { fetchTwitterPosts, fetchTwitterUserPosts } from "../../services/fetchTwitterPosts"
...
function SearchPage({ media, posts, id, users }: any): JSX.Element {
  ...
  return (
    <>
      <Head>
        <title>nftweet - tweets from : @{id}</title>
...
export const getServerSideProps = async ({
  ...
  const { posts } = await fetchTwitterUserPosts(id as string)
